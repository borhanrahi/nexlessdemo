...
export const PlaceholdersAndVanishInput = forwardRef<PlaceholdersAndVanishInputRef, PlaceholdersAndVanishInputProps>(
  ({ placeholders, onChange, onSubmit, type = "text" }, ref) => {
  ...
  const newDataRef = useRef<DataItem[]>([]);
